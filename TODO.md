...
- [ ] Build a reproducible benchmark suite for throughput, latency, memory use, and startup time.
- [ ] Compare Enqiu with BullMQ, Bee-Queue, and pg-boss using equivalent workloads.
